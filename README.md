...
- 感度調整補助: CS版向けに水平/垂直感度、エイムアシスト、スコープ相対感度の調整目安を表示
...
公式パッチノート、公式ニュース、公式大会、公式YouTubeへのリンクを添えて、イベント、強化、弱体化、Stadium調整、OWCS、動画告知を短く表示します。最新情報を反映するときは `app.js` の `PATCH_UPDATES` を更新してください。
